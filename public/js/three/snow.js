...
class SnowFlakes extends THREE.Object3D {
  constructor() {
    ...
    var sprite1 = textureLoader.load('img/snow/snowflake1.png');
    var sprite2 = textureLoader.load('img/snow/snowflake2.png');
    var sprite3 = textureLoader.load('img/snow/snowflake3.png');
